            ...
            <div id="carouselExampleControls" className="carousel slide banner" data-bs-ride="carousel">
                <div className="carousel-inner slider ">
                    <div className="carousel-item ">
                        <div className="row p-5  bg-gradient d-flex align-items-center">
                            ...
                            <div className="col-lg-7">
                                <h1 className="animate__bounceInDown" style={{ fontSize: "50px" }} >Capture the scene on camera</h1>
                    ...
                    <div className="carousel-item active ">
                        <div className="row p-5  bg-gradient d-flex align-items-center" >
                            <div className="col-lg-7">
                                <h1 className="animate__animated animate__bounce" style={{ fontSize: "50px" }} >Tour your dream destination with tourve. </h1>
                    ...
                    <div className="carousel-item">
                        <div className="row p-5  bg-gradient d-flex align-items-center">
                            ...
                            <div className="col-lg-7">
                                <h1 className="animate__pulse" style={{ fontSize: "50px" }}>Enjoy your best Moment </h1>
